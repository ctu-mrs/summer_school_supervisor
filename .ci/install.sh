...
echo "clone uvdar_leader_follower"
cd
git clone https://github.com/ctu-mrs/uvdar_leader_follower.git

mkdir -p ~/catkin_ws/src
cd ~/catkin_ws/src
ln -s ~/uav_core
ln -s ~/uvdar_leader_follower uvdar_leader_follower
ln -s "$MY_PATH" summer_school_supervisor
