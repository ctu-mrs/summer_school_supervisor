...
'
  'Nimbro' 'waitForRos; roslaunch mrs_uav_general nimbro.launch custom_config:=./custom_configs/communication_config.yaml
'
...
'
  'AutoStart' 'waitForRos; roslaunch summer_school_leader automatic_start.launch
'
